...
class donorSDG_Report(models.Model):
    _name = 'donor.sdg.report'
    _description = 'donor.sdg.report'
    ...
    def print_report(self):
        ...
        for report in self:
            ...
            # file_name = _('Donor Donation in SDG.xlsx')
            a = 1
            ...
            excel_sheet.merge_range('D2:E2', 'Salaries Percentage covered by donors in SDG', heading)
            ...
            fp.close()
            wizardmodel = self.env['donor.sdg.report.excel']
            ...
            return {
                ...
                'view_type': 'form',
                'view_mode': 'form',
                'res_model': 'donor.sdg.report.excel',
                'type': 'ir.actions.act_window',
                'target': 'new',
                'res_id': res_id.id,
            }

class donorSDG_Report_Excel(models.TransientModel):
    _name = 'donor.sdg.report.excel'
