...
class HrLoan(models.Model):
	...
	loan_amount = fields.Monetary(string="Loan Amount", required=True, store=True,currency_field='currency_id')
	...
	branch_id = fields.Many2one('res.branch',related="loan_type.branch_id",store=True)
